...
public class Interface {
	public static void main(String[] args) {
		...
		double hight = new java.util.Scanner(System.in).nextDouble();	//Scannerabfrage der Körpergröße durch Userinput
		
		System.out.println("Ihr Name ist also: " + name + " und sie sind " + age + " Jahre alt"); //Ausgabe der eingegebenen Daten
		System.out.print("Ihre Koerpergröße betraegt nach ihren Angaben: " + hight);
	}
}