...
public class Main 
{
	...
	{	
		...
		player.x = player.y = 1;	//Koordinaten des Spielers sind (1,1)
		...
		while(player.equals(door) != true)	//solange der Player nicht auf der Tür steht
		{
			...
			xplus = scan.nextInt();
			System.out.println("Bitte geben Sie an wie viele Schritte sie in y Richtung gehen möchten");
			yplus = scan.nextInt();
			player.move((player.x + xplus), (player.y + yplus));
